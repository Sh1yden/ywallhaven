...
- [ ] Добавить настройки.
- [ ] Доработка темы оформления интерфейса
- [ ] Исправление мелких багов UI
- [ ] Реальная логика в `cleanup()` (сейчас заглушка)
- [ ] Тесты (сейчас отсутствуют)
...
[Unreleased]: https://github.com/Sh1yden/ywallhaven/compare/v0.4.0...HEAD
